...
we tested it on four main architectures---MLP, ResBlock, InceptionBlock, and TransformerEncoder---and they all compile fine and get the right output tensor shapes in their forward pass
...
\begin{enumerate}
    ...
    \item NADER Framework: Neural Architecture Design via Representation 
    \item Zhang, A. M. \textit{amznotes LaTeX template}. \url{https://github.com/alexmingzhang/latex-notes-template}
\end{enumerate}
