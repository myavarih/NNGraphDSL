...
\begin{enumerate}
    ...
    \item \LR{NADER Framework: Neural Architecture Design via Representation .}
    \item \LR{Zhang, A. M. \textit{amznotes LaTeX template}. \url{https://github.com/alexmingzhang/latex-notes-template}}
\end{enumerate}
